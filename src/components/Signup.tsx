    ...
    return (
        <div className="flex bg-black">
            ...
            <div className="w-full md:w-2/5 bg-black flex justify-center items-center h-screen max-sm:hidden max-md:hidden">
                <div>
                    <h1 className="text-4xl font-bold mb-4 text-white">Solve Code</h1>
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className=' mb-4  justify-center py-1 sm:px-6 lg:px-8 '>
                            ...
                            <div className='bg-white py-12 px-4 shadow sm:rounded-lg sm:px-10'>
                                <div className='flex flex-col items-center justify-center gap-4'>
                                    ...
                                    <p className='font-light text-sm text-gray-600'>
                                        Log in to continue to SolveCode.
                                    </p>
                                    <button
                                        type='submit'
                        ...
                        <div className="p-2 text-center">
                            <p className="text-gray-400">New to SolveCode? <a href="#" className="text-blue-500">Sign up for an account</a></p>
                        </div>
                    </div>
                </div>
            </div>
